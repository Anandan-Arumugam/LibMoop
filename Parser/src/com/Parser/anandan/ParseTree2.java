...
public class ParseTree2 {
	...
	public ParseTree2(String Input,HashMap<Character, Double> OperandValues) {
	...
	private ParserNode constructTrignometaryNode(int i) {
		...
		System.out.println("Unary Operator - Sin Parse Tree:");
	...
	private ParserNode constructUnaryOperatorNode(int tokensCounter) {
		...
		System.out.println("Unary Operator - Sum Parse Tree:");
